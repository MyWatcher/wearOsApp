...
fun Settings(context: Context, navController: NavHostController, alarms: MutableState<Alarm>) {
    ...
    Column(
        modifier = Modifier
            ...
            .pointerInput(Unit) {
                detectTransformGestures { a, b, c, d ->
                    println("Rotary Value")
                    Log.d("PADOU", "coucou")
                }
            }
        ...
        Button(
            ...
            Row(
                ...
                Switch(
                    ...
                    onCheckedChange = { alarms.value.isAlarmActivate = it; isAlarmActivate = it }
                )
            }
        }
        Button(
                ...
                Row(
                    ...
                    if (isVibrationSelected) {
                        Switch(
                            ...
                            onCheckedChange = { alarms.value.vibration.isActivate = it; isVibrationActivate = it }
                        )
                    }
                }
                if (isVibrationSelected) {
                ...
                Row(
                    ...
                    if (isSoundSelected) {
                        Switch(
                            ...
                            onCheckedChange = { alarms.value.sound.isActivate = it; isSoundActivate = it }
                        )
                    }
                }
                if (isSoundSelected) {
